...
class _GamePageState extends State<GamePage> {
  ...
  Widget _Buttonnip(int num) {
    return Padding(
      padding: const EdgeInsets.all(4.0), //ระยะ ระหว่างปุ่ม
      child: InkWell(
        //การกด
        onTap: () {
          setState(() {
        ...
        child: Container(
            ...
            decoration: BoxDecoration(
                ...
                border: Border.all(
                    //ขอบ //ถ้า num!=-1 ให้มีขอบ (ปุ่มลบเลข)
            ...
            child: num == -1
                ? const Icon(
                    ...
                    color: Colors.purple,
                  ) //ถ้าเป็น -1 ให้โชว์เครื่องหมายลบ
                : const Icon(
                    Icons.close,
                    color: Colors.purple,
                  ) //-2 โชว์ x
  ...
  Widget _Buttonnum(int num) {
    return Padding(
      ...
      child: InkWell(
        ...
        customBorder: CircleBorder(), //ขนาดวงกลม
        child: Container(
          width: 60.0,
          height: 30.0,
          alignment: Alignment.center,
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                color: Colors.white70, //สีพื้นหลังของ container
                // border: Border.all(
                //   width: 5.0,
                //   color: Colors.pinkAccent,
                // ),
                borderRadius: BorderRadius.circular(8.0), //ปรับขอบมน ไม่เหลี่ยม
                boxShadow: [
                  BoxShadow(
                    color: Colors.purple.withOpacity(0.3), //เงาข้างหลัง
                    // spreadRadius: 5,//รอบ 4 ด้าน
                    blurRadius: 3, //รอบขอบจะมัวๆ
                    offset: const Offset(0, 0), // ซ้ายขวา ,บนล่าง
                  ),
                ],
              ),
              child: Column(
                children: [
                  ...
                  Text(
                    _feedbackText,
                    style: GoogleFonts.mali(fontSize: 15.0),
                  ),
                  const SizedBox(height: 10.0),
                  Column(
                    children: [
